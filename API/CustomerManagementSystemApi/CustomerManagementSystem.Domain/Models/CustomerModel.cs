...
// Request shape for POST /create. Deliberately all-nullable with no [Required], same
// reasoning as MerchantCredentials: CustomerCreation validates every field itself, so a
...
public sealed class CreateCustomerRequest
{
    ...
    // generator) — see CustomerCreation.
    public CustomerStatus? Status { get; set; }

    public AddressRequest? Address { get; set; }
}

// Request shape for PATCH /update: a partial update, so every field but Guid is optional and an
