...
public class CustomerCreation(IDbUtils dbUtils, ICustomerAuditLogger auditLogger)
{
    ...
    public async Task<ResponseModel<Guid?>> CreateCustomerFunction(CreateCustomerRequest request, string performedBy,
        CancellationToken cancellationToken = default)
    {
        ...
        var response = await dbUtils.CreateCustomer(request, cancellationToken);
