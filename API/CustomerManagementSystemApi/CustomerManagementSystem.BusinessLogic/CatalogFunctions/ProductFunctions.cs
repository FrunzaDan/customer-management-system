...
// Everything the product catalogue does. Products are a secondary entity, so, like the
// employee app's OfficeFunctions, one class holds all of it; the main entity (Customer)
// has one class per action.
