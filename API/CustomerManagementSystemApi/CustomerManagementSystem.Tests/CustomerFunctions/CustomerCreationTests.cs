...
public class CustomerCreationTests
{
    ...
    [InlineData("Dan", null)]
    [InlineData("Dan", "")]
    public async Task CreateCustomerFunction_RejectsMissingName_WithoutTouchingTheDb(string? firstName,
        string? lastName)
    {
        ...
        var result = await registration.CreateCustomerFunction(request, PerformedBy, TestContext.Current.CancellationToken);

        Assert.Equal(400, result.Status);
        Assert.Contains("name", result.ResponseMessage, StringComparison.OrdinalIgnoreCase);
        dbUtils.Verify(d => d.CreateCustomer(It.IsAny<CreateCustomerRequest>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task CreateCustomerFunction_RejectsInvalidEmail_WithoutTouchingTheDb(string? email)
    {
        var dbUtils = new Mock<IDbUtils>();
        var auditLogger = new Mock<ICustomerAuditLogger>();
        var registration = new CustomerCreation(dbUtils.Object, auditLogger.Object);
    ...
    [Fact]
    public async Task CreateCustomerFunction_RejectsAnEmailLongerThanTheColumn_WithoutTouchingTheDb()
    {
        var dbUtils = new Mock<IDbUtils>();
        var auditLogger = new Mock<ICustomerAuditLogger>();
        var registration = new CustomerCreation(dbUtils.Object, auditLogger.Object);
    ...
    [InlineData("")]
    [InlineData("123")]
    public async Task CreateCustomerFunction_RejectsInvalidPhoneNumber_WithoutTouchingTheDb(string? phoneNumber)
    {
        var dbUtils = new Mock<IDbUtils>();
        var auditLogger = new Mock<ICustomerAuditLogger>();
        var registration = new CustomerCreation(dbUtils.Object, auditLogger.Object);
    ...
    [Fact]
    public async Task CreateCustomerFunction_RejectsAMissingAddress_WithoutTouchingTheDb()
    {
        var dbUtils = new Mock<IDbUtils>();
        var auditLogger = new Mock<ICustomerAuditLogger>();
        var registration = new CustomerCreation(dbUtils.Object, auditLogger.Object);
    ...
    [Fact]
    public async Task CreateCustomerFunction_RejectsAnAddressWithAMissingField_WithoutTouchingTheDb()
    {
    ...
    [Fact]
    public async Task CreateCustomerFunction_RejectsAnUndefinedGender_WithoutTouchingTheDb()
    {
        var dbUtils = new Mock<IDbUtils>();
        var auditLogger = new Mock<ICustomerAuditLogger>();
        var registration = new CustomerCreation(dbUtils.Object, auditLogger.Object);
    ...
    public async Task CreateCustomerFunction_AcceptsNoStatusActiveOrTest(CustomerStatus? status)
    {
        var dbUtils = new Mock<IDbUtils>();
        var auditLogger = new Mock<ICustomerAuditLogger>();
    ...
    public async Task CreateCustomerFunction_RejectsAnyOtherStatus_WithoutTouchingTheDb(CustomerStatus status)
    {
        var dbUtils = new Mock<IDbUtils>();
        var auditLogger = new Mock<ICustomerAuditLogger>();
        var registration = new CustomerCreation(dbUtils.Object, auditLogger.Object);
    ...
    [Fact]
    public async Task CreateCustomerFunction_ReturnsTheDbGeneratedCustomerId_AndAuditLogsAgainstIt()
    {
        var dbUtils = new Mock<IDbUtils>();
        var auditLogger = new Mock<ICustomerAuditLogger>();
    ...
    [Fact]
    public async Task CreateCustomerFunction_DoesNotAuditLog_WhenTheDbRejectsIt()
    {
        var dbUtils = new Mock<IDbUtils>();
        var auditLogger = new Mock<ICustomerAuditLogger>();
        dbUtils.Setup(d => d.CreateCustomer(It.IsAny<CreateCustomerRequest>(), It.IsAny<CancellationToken>()))
